...
var isDataType = contains( [ 'binary' ] );
...
* @returns {boolean} boolean indicating whether an input value is a supported ndarray binary data type
*
* @example
...
module.exports = isBinaryDataType;
